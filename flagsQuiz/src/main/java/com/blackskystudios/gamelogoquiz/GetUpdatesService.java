package com.blackskystudios.gamelogoquiz;
...
import com.blackskystudios.gamelogoquiz.R;
			...
			public void run() {
				...
				try {
					...
					for (int i = 0; i < flags.length(); i++) {
						...
						String fl_name = e.getString("fl_name");
						String fl_country = e.getString("fl_country");
						String fl_city = e.getString("fl_city");
						int fl_is_country = e.getInt("fl_is_country");
